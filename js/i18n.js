(function (global) {
  ...
  const dict = {
    en: {
      ...
      stop_recording: "Stop",
      recording_error: "Unable to start recording. Please check your browser permissions.",
      no_recording_data: "No recording data available.",
      recording_saved: "Recording saved successfully!",
      share_video: "Share Your Game Video",
      video_ready: "Video Ready!",
      share_your_skills: "Show off your 2048 skills",
      ...
      close: "Close",
      youtube_upload_hint: "Caption copied! Please upload the downloaded video to YouTube and paste the caption.",
      tiktok_upload_hint: "Caption copied! Please upload the downloaded video to TikTok and paste the caption.",
      instagram_upload_hint: "Caption copied! Please upload the downloaded video to Instagram and paste the caption.",
    ...
    de: {
      ...
      recording_error: "Aufnahme kann nicht gestartet werden. Bitte überprüfen Sie Ihre Browser-Berechtigungen.",
      no_recording_data: "Keine Aufnahmedaten verfügbar.",
      recording_saved: "Aufnahme erfolgreich gespeichert!",
      share_video: "Teile dein Spiel-Video",
      video_ready: "Video bereit!",
      share_your_skills: "Zeige deine 2048-Fähigkeiten",
      share_caption: "Teilen-Text:",
      share_youtube: "YouTube",
      share_twitter: "Twitter/X",
      share_tiktok: "TikTok",
      share_instagram: "Instagram",
      download_only: "Nur herunterladen",
      copy_caption: "Text kopieren",
      close: "Schließen",
      youtube_upload_hint: "Text kopiert! Bitte lade das Video zu YouTube hoch und füge den Text ein.",
      tiktok_upload_hint: "Text kopiert! Bitte lade das Video zu TikTok hoch und füge den Text ein.",
      instagram_upload_hint: "Text kopiert! Bitte lade das Video zu Instagram hoch und füge den Text ein.",
      caption_copied: "Text in die Zwischenablage kopiert!",
    ...
    ja: {
      ...
      start_recording: "録画",
      stop_recording: "停止",
      recording_error: "録画を開始できません。ブラウザの権限を確認してください。",
      no_recording_data: "録画データがありません。",
      recording_saved: "録画が正常に保存されました！",
      share_video: "ゲーム動画を共有",
      video_ready: "動画準備完了！",
      share_your_skills: "2048のスキルを披露",
      share_caption: "共有キャプション：",
      share_youtube: "YouTube",
      share_twitter: "Twitter/X",
      share_tiktok: "TikTok",
      share_instagram: "Instagram",
      download_only: "ダウンロードのみ",
      copy_caption: "キャプションをコピー",
      close: "閉じる",
      youtube_upload_hint: "キャプションをコピーしました！動画をYouTubeにアップロードしてキャプションを貼り付けてください。",
      tiktok_upload_hint: "キャプションをコピーしました！動画をTikTokにアップロードしてキャプションを貼り付けてください。",
      instagram_upload_hint: "キャプションをコピーしました！動画をInstagramにアップロードしてキャプションを貼り付けてください。",
      caption_copied: "キャプションをクリップボードにコピーしました！",
      how_to_play: "遊び方:",
    ...
    ru: {
      ...
      stop_recording: "Стоп",
      recording_error: "Не удается начать запись. Пожалуйста, проверьте разрешения браузера.",
      no_recording_data: "Данные записи недоступны.",
      recording_saved: "Запись успешно сохранена!",
      share_video: "Поделиться игровым видео",
      video_ready: "Видео готово!",
      share_your_skills: "Покажите свои навыки в 2048",
      share_caption: "Текст для публикации:",
      share_youtube: "YouTube",
      share_twitter: "Twitter/X",
      share_tiktok: "TikTok",
      share_instagram: "Instagram",
      download_only: "Только скачать",
      copy_caption: "Копировать текст",
      close: "Закрыть",
      youtube_upload_hint: "Текст скопирован! Загрузите видео на YouTube и вставьте текст.",
      tiktok_upload_hint: "Текст скопирован! Загрузите видео в TikTok и вставьте текст.",
      instagram_upload_hint: "Текст скопирован! Загрузите видео в Instagram и вставьте текст.",
      caption_copied: "Текст скопирован в буфер обмена!",
